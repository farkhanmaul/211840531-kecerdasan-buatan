...
city_map = Graph(dict(
    ...
    Sibiu=dict(Sibiu=0, Fagaras=99, Rimnicu=80, Pitesti=143, Bucharest=232, Craiova=175),
    Fagaras=dict(Sibiu=99, Fagaras=0, Rimnicu=81, Pitesti=82, Bucharest=211, Craiova=169),
    Rimnicu=dict(Sibiu=80, Fagaras=81, Rimnicu=0, Pitesti=97, Bucharest=186, Craiova=146),
    Pitesti=dict(Sibiu=143, Fagaras=82, Rimnicu=97, Pitesti=0, Bucharest=101, Craiova=138),
    Bucharest=dict(Sibiu=232, Fagaras=211, Rimnicu=186, Pitesti=101, Bucharest=0, Craiova=152),
    Craiova=dict(Sibiu=175, Fagaras=169, Rimnicu=146, Pitesti=138, Bucharest=152, Craiova=0)),
    directed=False)
